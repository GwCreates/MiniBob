    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showDropdown && dropdownTheme.enumValueIndex == 0)
            {
                ...
                MUIPEditorHandler.DrawProperty(dropdownAnimationType, customSkin, "Animation Type");
                GUILayout.BeginHorizontal(EditorStyles.helpBox);
                EditorGUILayout.LabelField(new GUIContent("Font"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                ...
                MUIPEditorHandler.DrawProperty(dropdownItemColor, customSkin, "TItem Background");
