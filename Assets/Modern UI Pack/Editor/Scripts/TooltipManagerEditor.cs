        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    EditorGUILayout.LabelField(new GUIContent("Preferred Width"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                    EditorGUILayout.PropertyField(preferredWidth, new GUIContent(""));
                    ...
                    EditorGUILayout.LabelField(new GUIContent("Damp Speed"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                    EditorGUILayout.PropertyField(dampSpeed, new GUIContent(""));
